...
double compute_makespan() {
        ...
        std::vector<int> p = {0, 1, 2, 3, 4, 5, 6, 21, 22, 23, 24, 25, 26, 27, 7, 8, 9, 10, 11, 12, 13, 28, 29, 30, 31, 32, 33, 34, 42, 43, 44, 45, 46, 47, 48, 35, 36, 37, 38, 39, 40, 41, 49, 50, 51, 52, 53,
54, 55, 14, 15, 16, 17, 18, 56, 57, 19, 58, 59, 20, 60, 61, 62};
        cout<<p.size()<<endl;
        int size = p.size();
        std::vector<int> c;
        std::vector<int> idx;
